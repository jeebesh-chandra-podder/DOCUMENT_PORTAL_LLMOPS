...
class ModelLoader:
    ...
    def __init__(self):
        ...
        log.info(
            "✅[ __init__() ]  in [ model_loader.py ] loaded successfully. Configuration loaded successfully", 
    ...
    def _validate_env(self):
        ...
        if missing:           
            log.error(
                "❌ [ _validate_env() ] in [ model_loader.py ]. Missing environment variables",
                missing_vars=missing
            )
            raise DocumentPortalException("Missing environment variables", sys)
        
        log.info(
            "✅[ _validate_env() ] in [ model_loader.py ]. Environment variables validated",
    ...
    def load_embeddings(self):
        ...
        try:
            log.info("✅[ load_embeddings() ] in [ model_loader.py ]. Loading embedding model...")
    ...
    def load_llm(self):
        ...
        log.info("✅[ load_llm() ] in [ model_loader.py ]. Loading LLM...")
        ...
        if provider_key not in llm_block:
            log.error("❌[ load_llm() ] in [ model_loader.py ]. LLM provider not found in config", provider_key=provider_key)
        ...
        log.info(
            "✅[ load_llm() ] in [ model_loader.py ]. Loading LLM",
            provider=provider,
            model=model_name,
