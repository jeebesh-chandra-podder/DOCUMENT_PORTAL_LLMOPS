...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            "data\\mulit_doc_chat\\state_of_the_union.txt",
            "data\\mulit_doc_chat\\NIPS-2017-attention-is-all-you-need-Paper.pdf",
            "data\\mulit_doc_chat\\sample (2).pdf",
            "data\\mulit_doc_chat\\market_analysis_report.docx"
        ]
